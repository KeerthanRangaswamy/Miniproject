...
health_prompt = (
    ...
    "- Include specific nutritional values and medical insights\n"
    "- Provide actionable recommendations for the patient\n"
    "- If the FOOD ITEM or MEDICAL CONDITION contains underscores (_), convert them to spaces and capitalize each word to make it human-readable (e.g., 'chronic_kidney_disease' → 'Chronic Kidney Disease')\n\n"
    "### Input:\n"
    "FOOD ITEM: {food}\n"
    ...
    "safety evaluation, and provide specific recommendations for this food-condition combination.\n\n"
    "### Format your response exactly as follows:\n\n"
    "# Health Analysis: <Formatted Food Name> for <Formatted Medical Condition>\n\n"
    "## 🥗 Nutrient Highlights\n\n"
    "- [Detailed nutritional breakdown using **bold** for key nutrients and values]\n\n"
    "## 📋 Recommendation\n\n"
    "- [Specific, evidence-based dietary recommendations tailored to the condition]\n\n"
    "## 🔄 Alternative Suggestions\n\n"
    "- [Healthier substitute foods with similar taste or texture but better health value]\n\n"
    "## ⚠️ Safety Assessment\n\n"
    "**[Explicitly state: SAFE / SHOULD BE AVOIDED / SHOULD BE CONSUMED WITH CAUTION]**\n"
    "- [Explanation for the safety level based on the condition]\n\n"
    "## 📊 Effects on Condition\n\n"
    "- [Positive and negative effects of the food on the condition]\n\n"
    "## 🚨 Risk Factors\n\n"
    "- [Mention risk levels and associated triggers with preventive advice]\n\n"
    "Please provide a complete and medically sound analysis now."
)
